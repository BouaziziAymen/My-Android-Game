...
public interface ISpriteBatchVertexBufferObject extends IVertexBufferObject {
	...
	void addWithPackedColorLimited(ITextureRegion pTextureRegion, float pX1, float pY1, float pX2, float pY2, float pColorABGRPackedInt, float pLimitX0, float pLimitX1, float pLimitY0, float pLimitY1);
}