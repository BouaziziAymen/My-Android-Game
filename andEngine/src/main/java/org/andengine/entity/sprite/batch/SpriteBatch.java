...
//		GLState.enableDepthMask(pGL);
	...
	public void drawLimited(final ITextureRegion pTextureRegion, final float pX, final float pY, final float pRed, final float pGreen, final float pBlue, final float pAlpha, float pLimitX0, float pLimitX1, float pLimitY0, float pLimitY1) {
		this.assertCapacity();
		this.assertTexture(pTextureRegion);

		this.addLimited(pTextureRegion, pX, pY, pRed, pGreen, pBlue, pAlpha,pLimitX0,pLimitX1,pLimitY0,pLimitY1);
	...
	protected void addLimited(final ITextureRegion pTextureRegion, final float pX, final float pY, final float pRed, final float pGreen, final float pBlue, final float pAlpha, float pLimitX0, float pLimitX1, float pLimitY0, float pLimitY1) {
		this.addInnerLimited(pTextureRegion, pX+pLimitX0, pY+pLimitY0, pX + pLimitX1, pY + pLimitY1, pRed, pGreen, pBlue, pAlpha,pLimitX0,pLimitX1,pLimitY0,pLimitY1);
	}
	...
	private void addInnerLimited(final ITextureRegion pTextureRegion, final float pX1, final float pY1, final float pX2, final float pY2, final float pRed, final float pGreen, final float pBlue, final float pAlpha, float pLimitX0, float pLimitX1, float pLimitY0, float pLimitY1) {
		this.mSpriteBatchVertexBufferObject.addWithPackedColorLimited(pTextureRegion, pX1, pY1, pX2, pY2, ColorUtils.convertRGBAToABGRPackedFloat(pRed, pGreen, pBlue, pAlpha),pLimitX0,pLimitX1,pLimitY0,pLimitY1);
	}
	/**
	 * 1-3
	 * |X|
