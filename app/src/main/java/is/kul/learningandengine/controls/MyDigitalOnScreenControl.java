...
public class MyDigitalOnScreenControl extends MyBaseOnScreenControl {
    ...
    public MyDigitalOnScreenControl(final float pX, final float pY, final Camera pCamera, final ITiledTextureRegion pControlBaseTextureRegion, final ITextureRegion pControlKnobTextureRegion, final float pTimeBetweenUpdates, final VertexBufferObjectManager pVertexBufferObjectManager, final MyBaseOnScreenControl.IOnScreenControlListener pOnScreenControlListener) {
