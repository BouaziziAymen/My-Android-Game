...
//{title,hormg,vermg,pmg,range,verts,branch,analogspeed,fixedx,fixedy,cutstart,magtitle}
        if (grid[k][0]) title.setVisible(true);
        else title.setVisible(false);
        if (grid[k][1]) horMagnet.setVisible(true);
        else horMagnet.setVisible(false);
        if (grid[k][2]) verMagnet.setVisible(true);
        else verMagnet.setVisible(false);
        if (grid[k][3]) pointMagnet.setVisible(true);
        else pointMagnet.setVisible(false);
        if (grid[k][4]) {
            range.setVisible(true);
        } else range.setVisible(false);
        if (grid[k][5]) numVertices.setVisible(true);
        else numVertices.setVisible(false);
        if (grid[k][6]) branch.setVisible(true);
        else branch.setVisible(false);
        if (grid[k][7]) AnalogSpeed.setVisible(true);
        else AnalogSpeed.setVisible(false);
        if (grid[k][8]) fixedX.setVisible(true);
        else fixedX.setVisible(false);
        if (grid[k][9]) fixedY.setVisible(true);
        else fixedY.setVisible(false);
        if (grid[k][10]) cutStart.setVisible(true);
        else cutStart.setVisible(false);
        if (grid[k][11]) magTitle.setVisible(true);
        else magTitle.setVisible(false);
        if (grid[k][12]) cutLayerName.setVisible(true);
        else cutLayerName.setVisible(false);
        if (grid[k][13]) done.setVisible(true);
        else done.setVisible(false);
        if (grid[k][14]) undo.setVisible(true);
        else undo.setVisible(false);
        if (grid[k][15]) magnetFirstPoint.setVisible(true);
        else magnetFirstPoint.setVisible(false);
        if (grid[k][16]) magnetSecondPoint.setVisible(true);
        else magnetSecondPoint.setVisible(false);
        if (grid[k][17]) multiple.setVisible(true);
        else multiple.setVisible(false);
        if (grid[k][18]) hasLimits.setVisible(true);
        else hasLimits.setVisible(false);
        if (grid[k][19]) create.setVisible(true);
        else create.setVisible(false);
        if (grid[k][20]) addimage.setVisible(true);
        else addimage.setVisible(false);
        if (grid[k][21]) {
            pipeColorSlot.setVisible(true);
            addpipedcolor.setVisible(true);
        } else {
            pipeColorSlot.setVisible(false);
            addpipedcolor.setVisible(false);
        }
    }
