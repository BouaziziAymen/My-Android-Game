        ...
        for (IEntity entity : mChildren) {
            if (entity instanceof Line) {
                ...
                if (line.getX1() == line.getX2()) {
                    if (line.getX1() > xmax || line.getX1() < xmin) line.setVisible(false);
                    else line.setVisible(true);
                }

                if (line.getY1() == line.getY2()) {
                    if (line.getY1() > ymax || line.getY1() < ymin) line.setVisible(false);
                    else line.setVisible(true);
                }

                if (scale >= line.getTag()) line.setVisible(true);
