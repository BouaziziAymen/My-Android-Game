...
public class Sort {
	...
	public <T> void sort (Array<T> a) {
		if (this.comparableTimSort == null) this.comparableTimSort = new ComparableTimSort();
	...
	public <T> void sort (Array<T> a, Comparator<? super T> c) {
		if (this.timSort == null) this.timSort = new TimSort();
        this.timSort.doSort(a.items, (Comparator)c, 0, a.size);
	}
    ...
    public static Sort instance () {
		if (Sort.instance == null) Sort.instance = new Sort();
