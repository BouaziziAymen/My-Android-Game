...
public class PhysicsConstants {
    ...
    public static final float MINIMUM_STABLE_SPLINTER_AREA = 25f;
    ...
    public static final float LIQUID_DENSITY_CONSTANT = 0.25f;
    ...
    public static final float HEAT_CONSTANT = 20000f;
