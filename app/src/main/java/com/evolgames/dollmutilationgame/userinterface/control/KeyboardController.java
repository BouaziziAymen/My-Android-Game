...
import com.evolgames.dollmutilationgame.userinterface.view.inputs.KeyboardButton;
...
public class KeyboardController extends Controller {
    ...
    public void openKeyboard(
            float absoluteX, float absoluteY, float textFieldWidth, float textFieldHeight) {
