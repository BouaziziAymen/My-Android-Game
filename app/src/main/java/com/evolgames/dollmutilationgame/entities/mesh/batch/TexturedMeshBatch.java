...
public class TexturedMeshBatch extends Shape {
    ...
    public static final int TEXTURECOORDINATES_INDEX_V =
            TexturedMeshBatch.TEXTURECOORDINATES_INDEX_U + 1;
    ...
    public TexturedMeshBatch(
        ...
        this(
                pTexture,
                pCapacity,
                new HighPerformanceTexturedMeshBatchVertexBufferObject(
                        pVertexBufferObjectManager,
                        pCapacity,
                        pDrawType,
                        true,
                        TexturedMeshBatch.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
    }
    ...
    public TexturedMeshBatch(
            final ITexture pTexture,
            final int pCapacity,
            final HighPerformanceTexturedMeshBatchVertexBufferObject pSpriteBatchVertexBufferObject) {
        this(
                pTexture,
                pCapacity,
                pSpriteBatchVertexBufferObject,
    ...
    protected void assertTexture(final ITextureRegion pTextureRegion) {
        if (pTextureRegion.getTexture() != this.mTexture) {
            throw new IllegalArgumentException(
                    "The supplied Texture does match the Texture of this "
                            + this.getClass().getSimpleName()
                            + "!");
        }
    }
