...
import com.evolgames.dollmutilationgame.entities.mesh.batch.TexturedMeshBatch;
import com.evolgames.dollmutilationgame.entities.mesh.mosaic.MosaicMesh;
import com.evolgames.dollmutilationgame.entities.particles.wrappers.FireParticleWrapper;
...
public class GameEntity extends EntityWithBody {
    ...
    public synchronized void tryDynamicMirror() {
        ...
        for (JointBlock jointBlock : list) {
            if (used.contains(jointBlock)||!jointBlock.isNotAborted()||jointBlock.getBrother()==null||jointBlock.getJoint()==null) {
                continue;
            }
