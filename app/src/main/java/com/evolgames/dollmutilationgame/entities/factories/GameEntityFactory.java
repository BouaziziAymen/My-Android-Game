...
public class GameEntityFactory {
    ...
    public GameGroup createGameGroupTest(
        ...
        GameGroup gameGroup = new GameGroup(groupType);
        BodyInit bodyInit =
                new TransformInit(new BodyInitImpl(CollisionUtils.OBJECTS_MIDDLE_CATEGORY), position.x, position.y, 0);
        GameEntity entity =
    ...
    GameEntity createDollPart(
        ...
        filter.categoryBits =   (short)
                (CollisionUtils.OBJECTS_MIDDLE_CATEGORY | CollisionUtils.OBJECTS_FRONT_CATEGORY | CollisionUtils.OBJECTS_BACK_CATEGORY);
    ...
    public RagDoll createRagdoll(float x, float y) {
        ...
        revoluteJointDef.upperAngle = (float) (float) 0;
        revoluteJointDef.collideConnected = false;
