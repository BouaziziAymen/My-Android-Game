...
public class TexturedMesh extends Shape {
	...
	/**
	 * Uses a default {@link TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject} in {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	public TexturedMesh(float pX, float pY, float[] pBufferData, int pVertexCount, DrawMode pDrawMode, VertexBufferObjectManager pVertexBufferObjectManager) {
	 ...
	 * Uses a default {@link TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject} in {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	public TexturedMesh(float pX, float pY, float[] pBufferData, int pVertexCount, DrawMode pDrawMode, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager) {
		this(pX, pY, pBufferData, pVertexCount, pDrawMode, pTextureRegion, pVertexBufferObjectManager, DrawType.STATIC);
	}

	/**
	 * Uses a default {@link TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject} with the {@link VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	public TexturedMesh(float pX, float pY, float[] pBufferData, int pVertexCount, DrawMode pDrawMode, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
	 ...
	 * Uses a default {@link TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject} with the {@link VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	public TexturedMesh(float pX, float pY, float[] pBufferData, int pVertexCount, DrawMode pDrawMode, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
		this(pX, pY, pVertexCount, pDrawMode, pTextureRegion, new TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject(pVertexBufferObjectManager, pBufferData, pVertexCount, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}

	/**
	 * Uses a default {@link TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject} with the {@link VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	public TexturedMesh(float pX, float pY, float[] pVertexX, float[] pVertexY, DrawMode pDrawMode, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
		this(pX, pY, pVertexX.length, pDrawMode, pTextureRegion, new TexturedMesh.HighPerformanceTexturedMeshVertexBufferObject(pVertexBufferObjectManager, TexturedMesh.buildVertexList(pVertexX, pVertexY), pVertexX.length, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}

	public TexturedMesh(float pX, float pY, int pVertexCount, DrawMode pDrawMode, ITextureRegion pTextureRegion, TexturedMesh.ITexturedMeshVertexBufferObject pMeshVertexBufferObject) {
	...
	public static class HighPerformanceTexturedMeshVertexBufferObject extends HighPerformanceVertexBufferObject implements TexturedMesh.ITexturedMeshVertexBufferObject {

		private final int mVertexCount;

		public HighPerformanceTexturedMeshVertexBufferObject(VertexBufferObjectManager pVertexBufferObjectManager, float[] pBufferData, int pVertexCount, DrawType pDrawType, boolean pAutoDispose, VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
