...
public class MathUtils {
    ...
    private static class Cos {
        ...
        static {
            ...
            for (int i = 0; i < 360; i += 90)
                Cos.table[(int)(i * MathUtils.degToIndex) & MathUtils.SIN_MASK] = (float)Math.cos(i * MathUtils.degreesToRadians);
        }
    }
    ...
    private static final double BIG_ENOUGH_CEIL = NumberUtils
            .longBitsToDouble(NumberUtils.doubleToLongBits(MathUtils.BIG_ENOUGH_INT + 1) - 1);
