...
public class SegmentFreshCut extends FreshCut {
  ...
  public SegmentFreshCut() {
  }

  public SegmentFreshCut(Vector2 first, Vector2 second, boolean isInner, float density) {
    super(
        first.dst(second),
        (int) (first.dst(second) * PhysicsConstants.BLEEDING_CONSTANT * density),
        null);
    this.first = first;
    this.second = second;
  ...
  public SegmentFreshCut(
      Vector2 first, Vector2 second, boolean isInner, float density, Vector2 splashVelocity) {
    super(
        first.dst(second),
        (int) (first.dst(second) * PhysicsConstants.BLEEDING_CONSTANT * density),
        splashVelocity);
  ...
  public String toString() {
    return "SegmentFreshCut{" + "first=" + first + ", second=" + second + '}';
  }
