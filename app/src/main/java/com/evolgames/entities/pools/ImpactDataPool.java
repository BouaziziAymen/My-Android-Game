...
public class ImpactDataPool {
    ...
    private static final GenericPool<ImpactData> POOL = new GenericPool<ImpactData>() {
        @Override
    ...
    public static ImpactData obtain(GameEntity gameEntity, LayerBlock impactedBlock, Vector2 worldPoint) {
