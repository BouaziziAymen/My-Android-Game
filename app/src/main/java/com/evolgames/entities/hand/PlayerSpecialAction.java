...
public enum PlayerSpecialAction {
    ...
    Slash(R.drawable.slash_icon, false, true, false,R.string.slash_hint),
    Stab(R.drawable.stab_icon, false, true, false,R.string.stab_hint),
    Throw(R.drawable.hatchet_icon, false, true, false,R.string.throw_hint),
    Smash(R.drawable.mace_icon, false, true, false,R.string.bludgeon_hint),
    ...
    Guide(R.drawable.aim_icon, false, true, true),
