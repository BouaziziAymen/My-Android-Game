...
public class MaterialFactory {
    ...
    private MaterialFactory() {
        ...
        this.materials.add(new Material("Flesh", 11, new Color(255/255f, 204f/255f, 153f/255f), 1.01f, 1, 0f, 0.2f, liquids.get(0), 0.3f, 0.6f*5f, 1f*5f, true, 200 + 273, 700, 300));
        this.materials.add(new Material("Hard Flesh", 12, new Color(255/255f, 204f/255f, 153f/255f), 1.8f, 1, 0.05f, 0.4f, liquids.get(0), 0.25f*5f, 0.3f*5f, 0.5f, true, 220 + 273, 650, 300));
