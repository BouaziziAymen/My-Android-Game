...
public class Materials {
 ...
 public static int BLOOD = 0;
    ...
    static {
        ...
        liquids.add(new Liquid(PETROL, ResourceManager.getInstance().getString(R.string.petrol), 0.5f, new Color(156f / 255f, 89 / 255f, 0, 0.5f)));
        liquids.add(new Liquid(JUICE, ResourceManager.getInstance().getString(R.string.juice), 0f, new Color(1f,1f,1f,0.2f)));
        ...
        liquids.add(new Liquid(MILK, ResourceManager.getInstance().getString(R.string.milk), 0f, new Color(1f,1f,1f,0.9f)));
    }
