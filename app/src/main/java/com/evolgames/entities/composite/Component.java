...
public abstract class Component<T extends Component<T>> {
    ...
    public Iterator<T> createIterator() { throw new UnsupportedOperationException(); }
    public Iterator<T> getIterator() { throw new UnsupportedOperationException(); }
    public List<T> getChildren(){throw new UnsupportedOperationException();}
