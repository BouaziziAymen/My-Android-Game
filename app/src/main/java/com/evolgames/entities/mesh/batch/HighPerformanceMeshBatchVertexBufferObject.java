...
import static com.evolgames.entities.mesh.batch.MeshBatch.*;
...
public class HighPerformanceMeshBatchVertexBufferObject extends HighPerformanceVertexBufferObject {
    ...
    public HighPerformanceMeshBatchVertexBufferObject(final VertexBufferObjectManager pVertexBufferObjectManager, final int pCapacity, final DrawType pDrawType, final boolean pAutoDispose, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
    ...
    void addWithPackedColor(final float pX1, final float pY1, final float pX2, final float pY2, final float pX3, final float pY3, final float pColorABGRPackedInt) {
