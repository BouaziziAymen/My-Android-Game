...
public class FireParticleSystem extends FlowingParticleSystem{
    public FireParticleSystem(IEntityFactory<UncoloredSprite> ief, PolygonEmitter emitter, float rateMin, float rateMax, int particlesMax, TextureRegion textureRegion) {
