...
public class BlockA extends Block<BlockA, BlockAProperties> implements Comparable<BlockA> {
    ...
    private float Area;
    private Body body;
    private ArrayList<FreshCut> freshCuts = new ArrayList<>();
    ...
    public void performCut(Cut cut) {
        ...
        Pair<BlockA, BlockA> result = BlockUtils.cutBlockA(this, cut);
    ...
    @Override
    protected BlockA createChildBlock() {
        return new BlockA();
    }
    ...
    @Override
    protected BlockA getThis() {
        return this;
    }

    public List<BlockA> getChildren() {
        return children;
    }
