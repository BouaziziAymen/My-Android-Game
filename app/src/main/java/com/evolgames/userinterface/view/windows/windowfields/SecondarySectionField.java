...
public class SecondarySectionField<C extends AbstractSectionedAdvancedWindowController2> extends SimpleSecondary<ButtonWithText<C>> {


    public SecondarySectionField(int primaryKey,int secondaryKey, String sectionName, TiledTextureRegion textureRegion, C controller) {
        super(primaryKey, secondaryKey, new ButtonWithText<>(sectionName, 2, textureRegion, Button.ButtonType.Selector, true));
