...
public class TwoLevelSectionLayout<Primary extends Element, Secondary extends Element,Tertiary extends Element> extends SectionLayout<TwoLevelSection<Primary,Secondary,Tertiary>,Primary> {
    ...
    public TwoLevelSection<Primary,Secondary,Tertiary> getSectionByKey(int sectionKey){
        for(TwoLevelSection<Primary,Secondary,Tertiary> section:sectionsList)if(sectionKey==section.getSectionKey())return section;
    return null;
    }
    ...
    @Override
    protected TwoLevelSection<Primary, Secondary,Tertiary> createSection(int key,Primary p, boolean isActive) {
