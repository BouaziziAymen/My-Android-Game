...
public class SectionField<C extends AbstractSectionedAdvancedWindowController2> extends SimplePrimary<ButtonWithText<C>> {


    public SectionField(int primaryKey, String sectionName, TiledTextureRegion textureRegion, C controller) {
        super(primaryKey,  new ButtonWithText<>(sectionName, 2, textureRegion, Button.ButtonType.Selector, true));
