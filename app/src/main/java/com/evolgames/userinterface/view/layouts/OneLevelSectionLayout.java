...
public class OneLevelSectionLayout<Primary extends Element, Secondary extends Element> extends SectionLayout<OneLevelSection<Primary, Secondary>, Primary> {
    ...
    @Override
    protected OneLevelSection<Primary, Secondary> createSection(int key,Primary p, boolean isActive) {
    ...
    public OneLevelSection<Primary,Secondary> getSectionByKey(int sectionKey){
        for(OneLevelSection<Primary,Secondary> section:sectionsList)if(sectionKey==section.getSectionKey())return section;
        return null;
    }
