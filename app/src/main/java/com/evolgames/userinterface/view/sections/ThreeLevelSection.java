...
public class ThreeLevelSection<
        Primary extends Element,
        Secondary extends Element,
        Tertiary extends Element,
        Quaternary extends Element>
        extends CompositeSection<TwoLevelSection<Secondary, Tertiary, Quaternary>, Primary, Secondary> {
    ...
    public void addSecondary(int secondaryKey, Secondary secondary, boolean isActive) {
        TwoLevelSection<Secondary, Tertiary, Quaternary> secondarySection =
                new TwoLevelSection<>(secondaryKey, secondary, isActive);
    ...
    public void addQuaternary(
            int secondaryKey, int tertiaryKey, int quaternaryKey, Quaternary quaternary) {
        TwoLevelSection<Secondary, Tertiary, Quaternary> secondarySection =
                getSectionByKey(secondaryKey);
