...
public class SecondaryButton<C extends Controller> extends LinearLayout implements SecondaryInterface {
    private final ButtonWithText<C> mainControl;
    private final int primaryKey;
    private int secondaryKey;

    public SecondaryButton(int primaryKey, int secondaryKey, String sectionName, TiledTextureRegion textureRegion) {
        super(Direction.Horizontal, 4);
        this.primaryKey = primaryKey;
        this.secondaryKey = secondaryKey;
        mainControl = new ButtonWithText<>(sectionName, 2, textureRegion, Button.ButtonType.Selector, true);
