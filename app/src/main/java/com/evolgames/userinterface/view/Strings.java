...
public class Strings {
    public static final String DECORATION_DELETE_CONFIRM = "Are you sure you want to delete decoration, %s on layer, %s?";
    public static String LAYER_DELETE_CONFIRM = "Are you sure you want to delete layer, %s on body, %s?";
