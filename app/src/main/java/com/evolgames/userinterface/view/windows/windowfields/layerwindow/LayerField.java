...
public class LayerField extends SecondaryLinearLayout {
    ...
    public LayerField(int bodyFieldKey, int layerFieldKey, LayerWindowController controller) {
        ...
        layerAddDecorationButton = new Button<>(ResourceManager.getInstance().addTextureRegion, Button.ButtonType.OneClick, true);
        ...
        layerOptionsButton = new Button<>(ResourceManager.getInstance().smallOptionsTextureRegion, Button.ButtonType.OneClick, true);
        ...
        layerRemoveButton = new Button<>(ResourceManager.getInstance().removeTextureRegion, Button.ButtonType.OneClick, true);
