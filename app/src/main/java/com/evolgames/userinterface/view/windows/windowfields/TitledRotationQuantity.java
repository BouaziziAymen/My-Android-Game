...
public class TitledRotationQuantity<C extends AdvancedWindowController<?>> extends TitledField<RotationQuantity<C>> {

    public TitledRotationQuantity(String titleString, int length, String key, float margin, float minX, C controller) {
