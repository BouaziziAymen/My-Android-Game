...
public class TwoLevelSection<
        Primary extends Element, Secondary extends Element, Tertiary extends Element>
    extends CompositeSection<OneLevelSection<Secondary, Tertiary>, Primary, Secondary> {
  ...
  public void addSecondary(int secondaryKey, Secondary secondary, boolean isActive) {
    OneLevelSection<Secondary, Tertiary> secondarySection =
        new OneLevelSection<>(secondaryKey, secondary, isActive);
