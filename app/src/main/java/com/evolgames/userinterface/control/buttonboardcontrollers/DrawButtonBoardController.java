...
public class DrawButtonBoardController extends ButtonBoardController {
    ...
    public DrawButtonBoardController(ButtonBoard buttonBoard, CreationZoneController creationZoneController, OptionsWindowController optionsWindowController) {
        super(buttonBoard);
    ...
    public void onPolygonCreationButtonClicked(Button button){
        ...
        creationZoneController.setAction(CreationZoneController.CreationAction.ADD_POLYGON);
    }
    ...
    public void onAddPointButtonButtonClicked(Button button){
        onButtonClicked(button);
        creationZoneController.setAction(CreationZoneController.CreationAction.ADD_POINT);
    ...
    public void onRemovePointButtonClicked(Button button){
        onButtonClicked(button);
        creationZoneController.setAction(CreationZoneController.CreationAction.REMOVE_POINT);
    ...
    public void onMovePointButtonClicked(Button button){
        onButtonClicked(button);
        creationZoneController.setAction(CreationZoneController.CreationAction.MOVE_POINT);
    ...
    public void onMirrorButtonClicked(Button button) {
        onButtonClicked(button);
        creationZoneController.setAction(CreationZoneController.CreationAction.MIRROR);
    ...
    public void onRotateButtonClicked(Button<DrawButtonBoardController> button) {
        onButtonClicked(button);
        creationZoneController.setAction(CreationZoneController.CreationAction.ROTATE);
    ...
    public void onShiftButtonClicked(Button<DrawButtonBoardController> button) {
            onButtonClicked(button);
        creationZoneController.setAction(CreationZoneController.CreationAction.SHIFT);
