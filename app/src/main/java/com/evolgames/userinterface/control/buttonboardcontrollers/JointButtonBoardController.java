...
public class JointButtonBoardController extends ButtonBoardController {
    ...
    public JointButtonBoardController(ButtonBoard buttonBoard, CreationZoneController creationZoneController, OptionsWindowController optionsWindowController) {
        super(buttonBoard);
