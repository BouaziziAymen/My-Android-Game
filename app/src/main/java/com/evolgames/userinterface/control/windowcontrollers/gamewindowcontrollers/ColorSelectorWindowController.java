...
public class ColorSelectorWindowController extends LinearLayoutAdvancedWindowController<ColorSelectorWindow> {
    private final UserInterface userInterface;
    private Color copy = new Color(0, 0, 0, 0);
    private Button selectedSlot;
    private Color selectedColor;
    private Action acceptAction;
    public ColorSelectorWindowController(UserInterface userInterface){
    ...
    private void onColorUpdated(){
        ...
        Log.e("material","tool model address:"+userInterface.getToolModel().hashCode());
    ...
    public void addColorToPanel() {
        ColorSelector colorSelector = window.getSelector();
        window.getPanel().addColor(colorSelector.getRed(), colorSelector.getGreen(), colorSelector.getBlue());
