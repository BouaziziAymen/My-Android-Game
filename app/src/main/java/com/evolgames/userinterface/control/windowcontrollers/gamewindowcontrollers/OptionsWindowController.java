...
public class OptionsWindowController extends TwoLevelSectionedAdvancedWindowController<OptionsWindow, SimplePrimary<?>, SimpleSecondary<?>, SimpleTertiary<?>> {
    ...
    public void selectSettingsType(SettingsType settingsType) {
        ...
        switch (settingsType) {
            ...
            case PIPE_SETTINGS:
                ...
                Button<OptionsWindowController> colorValidatedButton = new Button<>(ResourceManager.getInstance().smallButtonTextureRegion, Button.ButtonType.OneClick, true);
                ...
                TitledField<LinearLayout> colorSelectionField = new TitledField<>("Piped Color:", linearLayout);
                colorValidatedButton.setBehavior(new ButtonBehavior<OptionsWindowController>(this, colorValidatedButton) {
                    @Override
                    public void informControllerButtonClicked() {
            ...
            case MOVE_POINT_SETTINGS:
                ...
                createReferenceButton.setBehavior(new ButtonBehavior<OptionsWindowController>(this, createReferenceButton) {
                    @Override
                    public void informControllerButtonClicked() {
            ...
            case POLYGON_CREATION_SETTINGS:
                ...
                TitledTextField<OptionsWindowController> polygonPointNumberField = new TitledTextField<>("Number Of Points:", 4, 5, 120);
                polygonPointNumberTextField = polygonPointNumberField.getAttachment();

                polygonPointNumberTextField.setBehavior(new TextFieldBehavior<OptionsWindowController>(this, polygonPointNumberTextField, Keyboard.KeyboardType.Numeric, polygonNumberValidator, true) {
                    @Override
                ...
                polygonPointNumberTextField.getBehavior().setReleaseAction(() -> {
                    int numberOfPoints = Integer.parseInt(polygonPointNumberTextField.getTextString());
                ...
                SimplePrimary<TitledTextField<?>> polygonPointsNumberElement = new SimplePrimary<>(0, polygonPointNumberField);
                window.addPrimary(polygonPointsNumberElement);


                TitledButton<OptionsWindowController> fixedRadiusButton = new TitledButton<>("Fixed Radius:", ResourceManager.getInstance().onoffTextureRegion, Button.ButtonType.Selector, 5f);
                SimplePrimary<TitledButton<?>> fixedRadiusField = new SimplePrimary<>(1, fixedRadiusButton);
                window.addPrimary(fixedRadiusField);
                fixedRadiusButton.getAttachment().setBehavior(new ButtonBehavior<OptionsWindowController>(this, fixedRadiusButton.getAttachment()) {
                    @Override
                    public void informControllerButtonClicked() {
                ...
                TitledTextField<OptionsWindowController> polygonRadiusField = new TitledTextField<>("Radius:", 4, 5, 48);
                polygonRadiusTextField = polygonRadiusField.getAttachment();

                polygonRadiusTextField.setBehavior(new TextFieldBehavior<OptionsWindowController>(this, polygonRadiusTextField, Keyboard.KeyboardType.Numeric, polygonRadiusValidator, true) {
                    @Override
                    protected void informControllerTextFieldTapped() {
                ...
                polygonRadiusTextField.getBehavior().setReleaseAction(() -> {
                ...
                SimpleSecondary<TitledTextField<?>> polygonRadiusElement = new SimpleSecondary<>(1, 0, polygonRadiusField);
            ...
            case IMAGE_SETTINGS:
                ...
                ButtonWithText<OptionsWindowController> addImageButton = new ButtonWithText<>
                        ("Add Image", 2, ResourceManager.getInstance().simpleButtonTextureRegion, Button.ButtonType.OneClick, true);


                SimplePrimary<ButtonWithText<?>> addImageField = new SimplePrimary<>(0, addImageButton);
                window.addPrimary(addImageField);

                addImageButton.setBehavior(new ButtonBehavior<OptionsWindowController>(this, addImageButton) {
                    @Override
                    public void informControllerButtonClicked() {
    ...
    public SimplePrimary<TitledField<ButtonBoard>> createMagnetBoard(int primaryId) {
        ...
        Button<OptionsWindowController> button1 = new Button<>(ResourceManager.getInstance().optionsMagnetTextureRegion, Button.ButtonType.Selector, true);
        Button<OptionsWindowController> button2 = new Button<>(ResourceManager.getInstance().optionsLinesTextureRegion, Button.ButtonType.Selector, true);
        Button<OptionsWindowController> button3 = new Button<>(ResourceManager.getInstance().optionsCenterTextureRegion, Button.ButtonType.Selector, true);
        magnetBoard.addToButtonBoard(button1);
        magnetBoard.addToButtonBoard(button2);
        magnetBoard.addToButtonBoard(button3);
        button1.setBehavior(new ButtonBehavior<OptionsWindowController>(this, button1) {
            @Override
            public void informControllerButtonClicked() {
                userInterface.getCreationZoneController().setMagnet(true);
            }

            @Override
            public void informControllerButtonReleased() {
                userInterface.getCreationZoneController().setMagnet(false);
            }
        });
        button2.setBehavior(new ButtonBehavior<OptionsWindowController>(this, button2) {
            @Override
            public void informControllerButtonClicked() {
                userInterface.getCreationZoneController().setMagnetLines(true);
            }

            @Override
            public void informControllerButtonReleased() {
                userInterface.getCreationZoneController().setMagnetLines(false);
            }
        });

        button3.setBehavior(new ButtonBehavior<OptionsWindowController>(this, button3) {
            @Override
            public void informControllerButtonClicked() {
                userInterface.getCreationZoneController().setMagnetCenters(true);
            }

            @Override
            public void informControllerButtonReleased() {
                userInterface.getCreationZoneController().setMagnetCenters(false);
            }
        });
    ...
    public SimplePrimary<TitledField<ButtonBoard>> createDirectionBoard(int primaryId) {
        ButtonBoard magnetBoard = new ButtonBoard(0, 0, LinearLayout.Direction.Horizontal, 1);
        Button<OptionsWindowController> horizontalButton = new Button<>(ResourceManager.getInstance().optionsHorTextureRegion, Button.ButtonType.Selector, true);
        Button<OptionsWindowController> verticalButton = new Button<>(ResourceManager.getInstance().optionsVerTextureRegion, Button.ButtonType.Selector, true);
        Button<OptionsWindowController> directionButton = new Button<>(ResourceManager.getInstance().optionsDirTextureRegion, Button.ButtonType.Selector, true);
        ...
        horizontalButton.setBehavior(new ButtonBehavior<OptionsWindowController>(this, horizontalButton) {
            @Override
            public void informControllerButtonClicked() {
                userInterface.getCreationZoneController().setDirection(Direction.HORIZONTAL);
        ...
        verticalButton.setBehavior(new ButtonBehavior<OptionsWindowController>(this, verticalButton) {
            @Override
            public void informControllerButtonClicked() {
                userInterface.getCreationZoneController().setDirection(Direction.VERTICAL);
        ...
        directionButton.setBehavior(new ButtonBehavior<OptionsWindowController>(this, directionButton) {
            @Override
            public void informControllerButtonClicked() {
                userInterface.getCreationZoneController().setDirection(Direction.OTHER);
                horizontalButton.updateState(Button.State.NORMAL);
                verticalButton.updateState(Button.State.NORMAL);
            }
    ...
    private SimplePrimary<TitledButton<?>> createReferenceOption(int primaryKey) {
        TitledButton<OptionsWindowController> referenceButton = new TitledButton<>("Reference :", ResourceManager.getInstance().onoffTextureRegion, Button.ButtonType.Selector, 5f);
        SimplePrimary<TitledButton<?>> referenceField = new SimplePrimary<>(primaryKey, referenceButton);
        referenceButton.getAttachment().setBehavior(new ButtonBehavior<OptionsWindowController>(this, referenceButton.getAttachment()) {
            @Override
            public void informControllerButtonClicked() {
        ...
        if (creationZoneController.isReferenceEnabled()) {
            ...
            if (referenceField.getSection() != null)
                onPrimaryButtonClicked(referenceField);
        } else {
    ...
    private SimplePrimary<TitledButton<?>> createMoveLimitsOption(int primaryKey) {
        TitledButton<OptionsWindowController> button = new TitledButton<>("Limits :", ResourceManager.getInstance().onoffTextureRegion, Button.ButtonType.Selector, 5f);
        SimplePrimary<TitledButton<?>> moveLimitsField = new SimplePrimary<>(primaryKey, button);
        button.getAttachment().setBehavior(new ButtonBehavior<OptionsWindowController>(this, button.getAttachment()) {
            @Override
            public void informControllerButtonClicked() {
    ...
    private SimplePrimary<TitledButton<?>> createCongruenceOption(int primaryKey) {
        TitledButton<OptionsWindowController> button = new TitledButton<>("Congruent Anchors :", ResourceManager.getInstance().onoffTextureRegion, Button.ButtonType.Selector, 5f);
